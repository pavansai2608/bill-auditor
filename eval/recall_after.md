# Retrieval recall - after the phantom-space fix - 2026-09-04

44 bills. Clause index `b1a7b301cef9`.
...
## Missed by every angle — 124 lines
...
| B05 | Surgeon Fee | `II.1` | other | ranked 4 | `I.Def55` |
...
| B09 | Surgeon Fee | `II.1` | other | ranked 4 | `I.Def55` |
...
| B12 | Surgeon Fee | `II.1` | other | ranked 4 | `I.Def55` |
...
| B14 | Surgeon Fee | `II.1` | other | ranked 4 | `I.Def55` |
...
| B17 | Surgeon Fee | `II.1` | other | ranked 4 | `I.Def55` |
...
| B22 | Surgeon Fee | `II.1` | other | ranked 4 | `I.Def55` |
...
| B26 | Surgeon Fee | `II.1` | other | ranked 4 | `I.Def55` |
...
| B27 | Room Rent (Shared) 3,500 x 3 days | `III.2` | room_rent | ranked 15 | `II.1` |
| B27 | Anaesthetist Charges | `III.2` | other | ranked 15 | `II.25` |
| B27 | Operation Theatre Charges | `III.2` | other | ranked 10 | `I.Def45` |
| B27 | Medicines and Drugs | `III.2` | other | ranked 10 | `II.16` |
| B27 | Physiotherapy Sessions | `III.2` | sub_limit | ranked 11 | `II.5` |
...
| B32 | Surgeon Fee | `II.1` | other | ranked 4 | `I.Def55` |
...
| B38 | Surgeon Fee | `II.1` | other | ranked 4 | `I.Def55` |
...
| B40 | Room Rent (Shared) 2,800 x 2 days | `III.2` | room_rent | ranked 15 | `II.1` |
| B40 | Anaesthetist Charges | `III.2` | other | ranked 15 | `II.25` |
| B40 | Operation Theatre Charges | `III.2` | other | ranked 10 | `I.Def45` |
| B40 | Medicines and Drugs | `III.2` | other | ranked 10 | `II.16` |
| B40 | Investigations - Basic Panel | `III.2` | other | ranked 13 | `IV.14` |
| B41 | Surgeon Fee | `II.1` | other | ranked 4 | `I.Def55` |
...
| B42 | Surgeon Fee | `II.1` | other | ranked 4 | `I.Def55` |
